...
exports.render = exports.getColorData = exports.FORMATS = exports.DEFAULT_CONFIG = exports.fromPaletteString = exports.toPaletteString = exports.PALETTE_REGEX = void 0;
...
exports.FORMATS = {
    hex(c) { return c.hex().substring(1); },
    hex_bgr(c) { const x = c.hex().substring(1); return x[4] + x[5] + x[2] + x[3] + x[0] + x[1]; },
    hex_r(c) { return c.red().toString(16).padStart(2, '0'); },
    hex_g(c) { return c.green().toString(16).padStart(2, '0'); },
    hex_b(c) { return c.blue().toString(16).padStart(2, '0'); },
    dec_r(c) { return c.red().toString(); },
    dec_g(c) { return c.green().toString(); },
    dec_b(c) { return c.blue().toString(); },
    frac_r(c) { return (c.red() / 255).toString(); },
    frac_g(c) { return (c.green() / 255).toString(); },
    frac_b(c) { return (c.blue() / 255).toString(); },
};
